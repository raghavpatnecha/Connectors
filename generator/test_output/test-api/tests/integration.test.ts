/**
 * Integration tests for Test API MCP Server
 *
...
describe("Test API MCP Server", () => {
  ...
  describe("Tool Definitions", () => {
    ...
    it("should have valid schema for listItems", () => {
      const schema = {
        type: "object",
        properties: {
          page: { type: "integer" },
  ...
  describe("listItems tool", () => {
    it("should make GET request to /items", async () => {
    ...
    it("should validate required parameters for listItems", () => {
