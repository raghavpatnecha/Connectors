/**
 * Integration tests for GitHub v3 REST API - oidc MCP Server
 *
...
describe("GitHub v3 REST API - oidc MCP Server", () => {
  beforeAll(() => {
  ...
  describe("Tool Definitions", () => {
    ...
    it("should have valid schema for oidcgetOidcCustomSubTemplateForOrg", () => {
      const schema = {
        type: "object",
        properties: {
          None: { type: "string" },
    ...
    it("should have valid schema for oidcupdateOidcCustomSubTemplateForOrg", () => {
      const schema = {
        type: "object",
        properties: {
          None: { type: "string" },
  ...
  describe("oidcgetOidcCustomSubTemplateForOrg tool", () => {
    it("should make GET request to /orgs/{org}/actions/oidc/customization/sub", async () => {
    ...
    it("should validate required parameters for oidcgetOidcCustomSubTemplateForOrg", () => {
      const requiredParams = ["org"];

      expect(requiredParams.length).toBeGreaterThan(0);
    });
  });
  describe("oidcupdateOidcCustomSubTemplateForOrg tool", () => {
    it("should make PUT request to /orgs/{org}/actions/oidc/customization/sub", async () => {
      const mockResponse = { data: { success: true } };
    ...
    it("should validate required parameters for oidcupdateOidcCustomSubTemplateForOrg", () => {
      const requiredParams = ["org"];
