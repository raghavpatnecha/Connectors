/**
 * Integration tests for GitHub v3 REST API - credentials MCP Server
 *
...
describe("GitHub v3 REST API - credentials MCP Server", () => {
  beforeAll(() => {
  ...
  describe("Tool Definitions", () => {
    ...
    it("should have valid schema for credentialsrevoke", () => {
      const schema = {
        type: "object",
        properties: {
  ...
  describe("credentialsrevoke tool", () => {
    it("should make POST request to /credentials/revoke", async () => {
    ...
    it("should validate required parameters for credentialsrevoke", () => {
      const requiredParams = ["credentials"];
