/**
 * Integration tests for GitHub v3 REST API - gitignore MCP Server
 *
...
describe("GitHub v3 REST API - gitignore MCP Server", () => {
  beforeAll(() => {
  ...
  describe("Tool Definitions", () => {
    ...
    it("should have valid schema for gitignoregetAllTemplates", () => {
      const schema = {
        type: "object",
        properties: {
        },
    ...
    it("should have valid schema for gitignoregetTemplate", () => {
      const schema = {
        type: "object",
        properties: {
          name: { type: "string" },
  ...
  describe("gitignoregetAllTemplates tool", () => {
    it("should make GET request to /gitignore/templates", async () => {
    ...
    it("should validate required parameters for gitignoregetAllTemplates", () => {
      const requiredParams = [];

      expect(requiredParams.length).toBe(0);
    });
  });
  describe("gitignoregetTemplate tool", () => {
    it("should make GET request to /gitignore/templates/{name}", async () => {
      const mockResponse = { data: { success: true } };
    ...
    it("should validate required parameters for gitignoregetTemplate", () => {
